...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button2.configure(command=self.train_model)
        ...
        self.Button3.configure(command=self.predict_face)
    ...
    def train_model(self):
        train = train_model()
        if train==True:
            messagebox.showinfo("Info","Model has been Trained")
            ...
            while True:
                ...
                if len(faces_coord):
                    ...
                    if flag_start_capturing == True:
                        sample += 1
                cv2.putText(frame, "Capture={}".format(sample), (5, frame.shape[0] - 5),cv2.FONT_HERSHEY_PLAIN, 1.3, (66, 53, 243), 2,cv2.LINE_AA)
